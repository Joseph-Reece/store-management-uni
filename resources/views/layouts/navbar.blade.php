    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item"><a class="navbar-brand" href="{{route('dashboard')}}"><img class="brand-logo" alt="Store Manager logo" src="/app-assets/images/logo/logos.png">
                        <h3 class="brand-text">Store Manager</h3>
                    </a></li>
